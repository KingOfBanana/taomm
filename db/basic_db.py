...
from config.conf import get_mm_db_args
# end
...
mm_db_eng = get_mmdb_engine()
mm_session = sessionmaker(bind=mm_db_eng)
mm_db_session = mm_session()
mm_db_metadata = MetaData(get_mmdb_engine())
# end

# __all__ = ['eng', 'Base', 'db_session', 'metadata']
__all__ = ['eng', 'Base', 'db_session', 'metadata', 'proxy_db_eng', 'proxy_db_session', 'proxy_db_metadata', 'mm_db_eng', 'mm_db_session', 'mm_db_metadata']