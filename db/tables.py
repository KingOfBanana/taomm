...
from db.basic_db import mm_db_metadata
# login table
...
mm_info = Table("mm_info", mm_db_metadata,
                  Column('id', INTEGER, primary_key=True, autoincrement=True),
                  Column('uid', INTEGER, nullable=False),
                  Column('name', VARCHAR(20), nullable=False),
                  Column('home_crawled', INTEGER, nullable=False, default=0, server_default='0'),
                  )
mm_pic = Table("mm_pic", mm_db_metadata,
                  Column('id', INTEGER, primary_key=True, autoincrement=True),
                  Column("uid", String(15)),
                  Column("album_id", String(15)),
                  Column("pic_id", String(15)),
                  Column("pic_url", String(200)),
...
__all__ = ['login_info', 'wbuser', 'seed_ids', 'keywords', 'weibo_data', 'keywords_wbdata', 'weibo_comment',
           'weibo_repost', 'user_relation', 'weibo_pic', 'proxys', 'proxy_source', 'mm_info', 'mm_pic']